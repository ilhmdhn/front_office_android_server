...
class CheckinProses {
  ...
  updateIhpRcp(db_, kode_rcp_,
    qm1_, qm2_, qm3_, qm4_, qf1_, qf2_, qf3_, qf4_, pax_, hp_,
...
WHERE
 IHP_Ivc_.Reception = '${kode_rcp}'`;
  ...
  updateRecountIhpIvc(db_, kode_rcp_) {
   ...
   IHP_Ivc_ 
SET
   IHP_Ivc_.Charge_Penjualan = isnull(IHP_Okl_.total_penjualan, 0) , IHP_Ivc_.Total_Cancelation = isnull(IHP_Ocl_.total_cancelation, 0) , IHP_Ivc_.Discount_Penjualan = isnull(IHP_Okl_.total_discount_penjualan, 0) - isnull(IHP_Ocl_.total_discount_penjualan_cancelation, 0), IHP_Ivc_.Service_Penjualan = 
   (
(isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0) - (isnull(IHP_Okl_.total_discount_penjualan, 0) - isnull(IHP_Ocl_.total_discount_penjualan_cancelation, 0))) / 100 
   )
   * IHP_Config2.Service_Persen_Food, IHP_Ivc_.Tax_Penjualan = 
   (
(isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0)) + ( (isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0) - (isnull(IHP_Okl_.total_discount_penjualan, 0) - isnull(IHP_Ocl_.total_discount_penjualan_cancelation, 0))) / 100 ) * IHP_Config2.Service_Persen_Food 
   )
    / 100 * IHP_Config2.Tax_Persen_Food, IHP_Ivc_.Total_Penjualan = 
   (
      isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0)
   )
    + ( (isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0) - (isnull(IHP_Okl_.total_discount_penjualan, 0) - isnull(IHP_Ocl_.total_discount_penjualan_cancelation, 0))) / 100 ) * IHP_Config2.Service_Persen_Food + ( (isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0)) + ( (isnull(IHP_Okl_.total_penjualan, 0) - isnull(IHP_Ocl_.total_cancelation, 0) - (isnull(IHP_Okl_.total_discount_penjualan, 0) - isnull(IHP_Ocl_.total_discount_penjualan_cancelation, 0))) / 100 ) * IHP_Config2.Service_Persen_Food ) / 100 * IHP_Config2.Tax_Persen_Food, IHP_Ivc_.Sewa_Kamar_Sebelum_Diskon = isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0), IHP_Ivc_.Diskon_Sewa_Kamar = isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0), IHP_Ivc_.Total_Extend_Sebelum_Diskon = isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0), IHP_Ivc_.Diskon_Extend_Kamar = isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0), IHP_Ivc_.Sewa_Kamar = isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0), IHP_Ivc_.Total_Extend = isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0), IHP_Ivc_.Discount_Kamar = 
   (
      isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher 
   )
    / 100*(isnull(IHP_Mbr.Diskon_Room, 0)), IHP_Ivc_.Service_Kamar = 
   (
( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) - ( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) / 100*(isnull(IHP_Mbr.Diskon_Room, 0)) + IHP_Ivc_.Surcharge_Kamar
    ...
    / 100*IHP_Config2.Service_Persen_Room, IHP_Ivc_.Tax_Kamar = 
   (
( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) - ( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) / 100*(isnull(IHP_Mbr.Diskon_Room, 0)) + ( ( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) - ( isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher ) / 100*(isnull(IHP_Mbr.Diskon_Room, 0)) + IHP_Ivc_.Surcharge_Kamar) / 100*IHP_Config2.Service_Persen_Room 
    ...
    / 100*IHP_Config2.Tax_Persen_Room, IHP_Ivc_.Total_Kamar = 
   (
      isnull(IHP_Detail_Sewa_Kamar_.total_tarif_kamar_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_.total_promo_kamar, 0) + isnull(IHP_Detail_Sewa_Kamar_Extend_.total_tarif_kamar_extend_sebelum_diskon, 0) - isnull(IHP_Detail_Diskon_Sewa_Kamar_Extend_.total_promo_kamar_extend, 0) + IHP_Ivc_.Overpax - IHP_Ivc_.Uang_Voucher 
   )
