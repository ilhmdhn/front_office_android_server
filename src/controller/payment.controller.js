        ...
        if (create_file_pdf != false) {
          ...
          let info = await transporter.sendMail({
            ...
            text:
              ...
              //"Please note that it could take 24-48 hours for points to be added to your PuppyClub Account. 
              "PuppyClub app can be downloaded from the Apple App Store or Google Play Store for a better experience.\n\n" +
